...
app.get("/addtempdata", async (req, res) => {
  ...
  res.send("Temporary Data saved successfully");
});
app.get("/addtempdatap", async (req, res) => {
  const tempData = [
    {
      product: "CNC",
      name: "EVEREADY",
  ...
  res.send("Temporary positions Data saved successfully");
});
